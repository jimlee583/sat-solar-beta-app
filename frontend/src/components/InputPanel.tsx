...
export default function InputPanel({ onAnalyze, loading }: InputPanelProps) {
  ...
  function validate(): boolean {
    ...
    if (form.outer_rate_limit_deg_per_s <= 0)
      e.outer_rate_limit = "Must be > 0";
    if (form.inner_rate_limit_deg_per_s <= 0)
      e.inner_rate_limit = "Must be > 0";
    setErrors(e);
  ...
  return (
    <form onSubmit={handleSubmit} style={styles.form}>
      ...
      <label style={styles.label}>
        ...
        <input type="number" step="0.1" min={0.01} value={form.outer_rate_limit_deg_per_s}
      ...
      <label style={styles.label}>
        ...
        <input type="number" step="0.1" min={0.01} value={form.inner_rate_limit_deg_per_s}
